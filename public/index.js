...
const sellerForm = document.querySelector("#complete");
...
function listHome(evt) {
  ...
  let homePhone = document.querySelector("#home-seller-phone");
  ...
  axios.post(`${baseURL}/api/home`, body).then((res) => {
    img: homeImg.value = "";
    address: homeAddress.value = "";
    price: homePrice.value = "";
    squareFeet: homeSqFt.value = "";
...
if (sellerForm) {
  sellerForm.addEventListener("click", listHome);
}
